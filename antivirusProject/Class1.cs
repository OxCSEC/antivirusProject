...
namespace antivirusProject
{
	...
	class Files
	{
		...
		public void RunScan(string file = null)
		{
			...
			if (file == null)
			{
				currentDir = "C:\\Users\\ozgur\\OneDrive\\Masaüstü\\test";
			}
			else
			{
				currentDir = file;
		...
		{
			string fileName = "C:\\Users\\ozgur\\OneDrive\\Masaüstü\\everything\\code\\C#\\MakeITEasy\\antivirusProject\\antivirusProject\\MALWARES.txt";
			try
			{
